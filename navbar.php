        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../Device-Direct-Team-27/productspage/index.php">Shop</a></li>
                    <li class="nav-item"><a class="nav-link" href="../Device-Direct-Team-27/aboutuspage/aboutus.php">About</a></li>
                    <li class="nav-item"><a class="nav-link" href="../Device-Direct-Team-27/contactuspage/contactus.php">Contact</a></li>

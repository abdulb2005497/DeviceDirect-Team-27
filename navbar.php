...
<!-- This is the working Navbar -->
    <nav class="navbar navbar-expand-lg" id="navbar">
        <div class="container-fluid">
            ...
            <img src="<?php echo $_SERVER['DOCUMENT_ROOT']; ?>/DEVICEDIRECT-TEAM-27/assests/images/device_direct_logo.png" alt="Device Direct Logo" class="logo-img">
  ...
  <section class="searchsectionnav">
    <form>
    <img src="<?php echo $_SERVER['DOCUMENT_ROOT']; ?>/DEVICEDIRECT-TEAM-27/productspage/categoryimages/search.png" alt="Search Icon">

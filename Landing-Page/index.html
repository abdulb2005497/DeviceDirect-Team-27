  ...
  <body>
    ...
    <section class="home">
      <div class="content">
        <h1>
          <br />
          Latest Tech <span id="span2">Unbeatable Prices!</span>
        </h1>
        <p>
          Found it cheaper? We wil match it! <br />We will price match against
    ...
    <div class="container" id="product-cards">
      <h1 class="text-center" style="color: #212f3d">Recommended for you</h1>
      <div class="row" style="margin-top: 30px">
        <div class="col-md-3 py-3 py-md-0">
          <div class="card">
            <img src="./assests/images/samsung tv.jpeg" alt="" />
            <div class="card-body">
              <h3 class="text-center">Samsung S95D 65" OLED 2024</h3>
              <h2>
        ...
        <div class="col-md-3 py-3 py-md-0">
          <div class="card">
            <img src="./assests/images/a1.png" alt="" />
            <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
          <div class="card">
            <img src="./assests/images/laptop2.png" alt="" />
            <div class="card-body">
              ...
              <h2>
                £200 <span><li class="fa-solid fa-cart-shopping"></li></span>
              </h2>
            </div>
          </div>
        </div>
        <div class="col-md-3 py-3 py-md-0">
          <div class="card">
            <img src="./assests/images/t1.png" alt="" />
            <div class="card-body">
      ...
      <div class="row" style="margin-top: 30px">
        <div class="col-md-3 py-3 py-md-0">
          <div class="card">
            <img src="./assests/images/w1.png" alt="" />
            <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
          <div class="card">
            <img src="./assests/images/pcm1.png" alt="" />
            <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
          <div class="card">
            <img src="./assests/images/phone1.png" alt="" />
            <div class="card-body">
        ...
        <div class="col-md-3 py-3 py-md-0">
          <div class="card">
            <img src="./assests/images/h1.png" alt="" />
            <div class="card-body">

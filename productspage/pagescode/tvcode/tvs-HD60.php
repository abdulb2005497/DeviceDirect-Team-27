 ...
 <nav class="navbar navbar-expand-lg" id="navbar">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="TVs/60inch/HD-60-Black.webp"
          width="100%"
          id="normal"
          alt=""
        />
        <div class="secimages">
          ...
          <div class="secimagescols">
            <img
              src="TVs/60inch/HD-60-White.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">HD 60 Inch Black TV</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: HD 60 Inch Black TV
        </h4>
        <br />
        <span id="pdescription"
          >Elevate your home entertainment experience with the HD 60 Inch Black
          TV, a stunning blend of size, style, and performance. Featuring crisp
          high-definition resolution, vivid color reproduction, and a sleek
          aesthetic, this TV is the centerpiece for any living space. Whether
          you're watching blockbuster movies or binge-watching your favorite
          series, the expansive 60-inch display ensures you won’t miss a single
          detail. With 4D surround sound, HDMI, and USB ports for ultimate
          connectivity, it's ready to take your viewing experience to the next
          level. Don't wait—get this incredible HD TV today at an unbeatable
          price. Upgrade now to experience entertainment like never
          before!</span
        >
      </div>
    </section>

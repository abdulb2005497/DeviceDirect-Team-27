 ...
 <nav class="navbar navbar-expand-lg" id="navbar">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="TVs/80inch/4k-80-Black.webp"
          width="100%"
          id="normal"
          alt=""
        />
        <div class="secimages">
          ...
          <div class="secimagescols">
            <img
              src="TVs/80inch/4k-80-White.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">80-Inch Black TV 4k</h4>
        <br />
        <h2 id="pprice"><del>£349.99</del> £299.99</h2>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: 4K 80 Inch Black TV
        </h4>
        <br />
        <span id="pdescription"
          >Immerse yourself in cinematic brilliance with the 4K 80 Inch Black
          TV—the ultimate centerpiece for your entertainment space. Its enormous
          display paired with stunning 4K resolution ensures every scene comes
          to life with razor-sharp detail and vivid color accuracy. Whether
          you’re hosting a movie marathon, gaming tournament, or sports viewing
          party, this TV delivers a truly immersive experience. With
          cutting-edge surround sound and versatile connectivity, it’s the
          perfect combination of technology and design. Limited Time Offer: Take
          this opportunity to own the pinnacle of home entertainment at a
          fraction of the cost. Click now to claim yours before it’s gone!</span
        >
      </div>
    </section>
    <!-- footer -->

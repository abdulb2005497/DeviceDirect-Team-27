 ...
 <nav class="navbar navbar-expand-lg" id="navbar">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="TVs/40inch/4K-40-Black.webp"
          width="100%"
          id="normal"
          alt=""
        />
        <div class="secimages">
          ...
          <div class="secimagescols">
            <img
              src="TVs/40inch/4k-40-White.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">40-Inch Black TV 4K</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: 4K 40 Inch Black TV
        </h4>
        <br />
        <span id="pdescription"
          >Discover the brilliance of ultra-high definition with the 4K 40 Inch
          Black TV. Compact yet powerful, this TV combines sleek design with
          cutting-edge 4K resolution, offering unparalleled clarity and lifelike
          color details. Perfect for bedrooms, kitchens, or smaller living
          spaces, this TV ensures every pixel delivers perfection, whether
          you’re streaming, gaming, or watching live TV. Complete with advanced
          sound technology and seamless connectivity through HDMI and USB, it’s
          designed to fit effortlessly into your modern lifestyle. Don’t miss
          out—upgrade to 4K quality now and enjoy an exclusive offer for a

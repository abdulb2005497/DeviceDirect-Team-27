  ...
  <body data-model="wiiu">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="Consoles/wiiu/wiiublack.webp"
          width="100%"
          id="normal"
          alt=""
        />
        <div class="secimages">
          ...
          <div class="secimagescols">
            <img
              src="Consoles/wiiu/Wii U white.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
          ...
          <div class="secimagescols">
            <img
              src="Consoles/wiiu/Wii U red.webp"
              width="100%"
              class="smallimg"
              id="red"
            />
      ...
      <div class="maindescription">
        ...
        <br />
        <br />
        <h4 id="pdescriptionheading">Product Description: Black Wii U</h4>
        <br />
        <span id="pdescription"
          >Step into the next generation of gaming with the black Wii U, a
          console that combines high-definition visuals with innovative
          gameplay. Featuring the groundbreaking GamePad controller with a
          touchscreen, the Wii U opens up new ways to interact with games,
          offering dual-screen functionality and enhanced immersion. The sleek
          black design adds a touch of sophistication, making it a stylish
          centerpiece for your entertainment setup. Enjoy an extensive library
          of titles, from family-friendly classics to action-packed adventures,
          all designed to take advantage of the console’s unique capabilities.
          Whether you’re playing solo or with friends, the black Wii U is your
          gateway to unforgettable gaming experiences.</span
        >
      </div>
    </section>

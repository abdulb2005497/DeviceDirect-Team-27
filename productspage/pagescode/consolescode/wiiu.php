...
<body data-model="wiiu">
    ...
    <section id="details" class="diffitems">
        <div class="mainimage">
            <img src="Consoles/wiiu/wiiublack.webp" width="100%" id="product-image" alt="Black Wii U" />
            <div class="secimages">
                <div class="secimagescols"><img src="Consoles/wiiu/wiiublack.webp" width="100%" class="smallimg" id="black" /></div>
                <div class="secimagescols"><img src="Consoles/wiiu/Wii U white.webp" width="100%" class="smallimg" id="white" /></div>
                <div class="secimagescols"><img src="Consoles/wiiu/Wii U red.webp" width="100%" class="smallimg" id="red" /></div>
            </div>
        </div>
        <div class="maindescription">
            <h4 id="pname">Black Wii U</h4>
            <h2 id="pprice"><del>£199.99</del> £99.99</h2>
            <form action="wiiu.php" method="POST">
                <select id="colourselector" name="colour" onchange="updateProductDetails()">
                    <option value="Black" data-price="99.99" data-name="Black Wii U" data-image="Consoles/wiiu/wiiublack.webp">Black</option>
                    <option value="White" data-price="109.99" data-name="White Wii U" data-image="Consoles/wiiu/Wii U white.webp">White</option>
                    <option value="Red" data-price="109.99" data-name="Red Wii U" data-image="Consoles/wiiu/Wii U red.webp">Red</option>
                </select>
                <input type="number" name="quantity" id="quantity" value="1" min="1" required />
                <input type="hidden" name="product_id" value="4" />
                <input type="hidden" name="product_name" id="product_name" value="Black Wii U" />

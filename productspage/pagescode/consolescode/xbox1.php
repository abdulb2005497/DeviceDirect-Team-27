  ...
  <body data-model="xbox1">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="Consoles/xbox/xboxblack.webp"
          width="100%"
          id="normal"
          alt=""
        />
      ...
      <div class="maindescription">
        ...
        <br />
        <br />
        <h4 id="pdescriptionheading">Product Description: Black XBox 1</h4>
        <br />
        <span id="pdescription"
          >The black Xbox is a powerhouse designed for serious gamers, offering
          next-gen performance and a sleek, modern aesthetic. With support for
          4K gaming, lightning-fast load times, and advanced hardware, it
          delivers an immersive experience across a wide range of titles. Its
          bold black finish adds a professional touch to any setup, while its
          seamless online connectivity ensures smooth multiplayer gameplay.
          Whether you’re streaming, gaming, or exploring expansive open worlds,
          the black Xbox delivers flawless performance.</span
        >
      </div>
    </section>

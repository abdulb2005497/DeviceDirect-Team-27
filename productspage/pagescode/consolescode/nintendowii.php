...
<body data-model="wii">
    ...
    <section id="details" class="diffitems">
        <div class="mainimage">
            <img src="Consoles/wii/wiiblack.webp" width="100%" id="product-image" alt="Black Wii" />
            <div class="secimages">
                <div class="secimagescols"><img src="Consoles/wii/wiiblack.webp" width="100%" class="smallimg" id="black" /></div>
                <div class="secimagescols"><img src="Consoles/wii/Wii white.webp" width="100%" class="smallimg" id="white" /></div>
                <div class="secimagescols"><img src="Consoles/wii/Wii red.webp" width="100%" class="smallimg" id="red" /></div>
            </div>
        </div>
        <div class="maindescription">
            <h4 id="pname">Black Wii</h4>
            <h2 id="pprice"><del>£199.99</del> £99.99</h2>
            <form action="nintendowii.php" method="POST">
                <select id="colourselector" name="colour" onchange="updateProductDetails()">
                    <option value="Black" data-price="99.99" data-name="Black Wii" data-image="Consoles/wii/wiiblack.webp">Black</option>
                    <option value="White" data-price="109.99" data-name="White Wii" data-image="Consoles/wii/Wii white.webp">White</option>
                    <option value="Red" data-price="109.99" data-name="Red Wii" data-image="Consoles/wii/Wii red.webp">Red</option>
                </select>
                <input type="number" name="quantity" id="quantity" value="1" min="1" required />
                <input type="hidden" name="product_id" value="5" />
                <input type="hidden" name="product_name" id="product_name" value="Black Wii" />

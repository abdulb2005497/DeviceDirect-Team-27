  ...
  <body data-model="ps5">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img src="Consoles/PS5/s5black.webp" width="100%" id="normal" alt="" />
        <div class="secimages">
          <div class="secimagescols">
            <img
              src="Consoles/PS5/s5black.webp"
              width="100%"
              class="smallimg"
              id="black"
            />
          ...
          <div class="secimagescols">
            <img
              src="Consoles/PS5/PS5 White.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
      ...
      <div class="maindescription">
        ...
        <br />
        <br />
        <h4 id="pdescriptionheading">Product Description: Black PS5</h4>
        <br />
        <span id="pdescription"
          >The black PlayStation 5 is a next-gen powerhouse that redefines
          gaming with its sleek design and groundbreaking performance. Featuring
          lightning-fast SSD storage, stunning 4K graphics, and immersive
          DualSense controller technology, the PS5 delivers unmatched gaming
          experiences. Its bold black finish adds a professional and modern
          touch, making it a standout addition to any gaming setup. Whether
          you’re exploring massive open worlds or engaging in intense
          multiplayer battles, the black PS5 offers flawless performance for
          every gamer.</span
        >
      </div>
    </section>

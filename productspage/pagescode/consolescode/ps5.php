...
<body data-model="ps5">
    ...
    <section id="details" class="diffitems">
        <div class="mainimage">
            <img src="Consoles/PS5/s5black.webp" width="100%" id="product-image" alt="Black PS5" />
            <div class="secimages">
                <div class="secimagescols">
                    <img src="Consoles/PS5/s5black.webp" width="100%" class="smallimg" id="black" />
                </div>
                <div class="secimagescols">
                    <img src="Consoles/PS5/PS5 White.webp" width="100%" class="smallimg" id="white" />
                </div>
                <div class="secimagescols">
                    <img src="Consoles/PS5/PS5 red.webp" width="100%" class="smallimg" id="red" />
                </div>
            </div>
        </div>
        <div class="maindescription">
            <h4 id="pname">Black PS5</h4>
            ...
            <form action="ps5.php" method="POST">
                <select id="colourselector" name="colour" onchange="updateProductDetails()">
                    <option value="Black" data-price="149.99" data-name="Black PS5" data-image="Consoles/PS5/s5black.webp">Black</option>
                    <option value="White" data-price="159.99" data-name="White PS5" data-image="Consoles/PS5/PS5 White.webp">White</option>
                    <option value="Red" data-price="159.99" data-name="Red PS5" data-image="Consoles/PS5/PS5 red.webp">Red</option>
                </select>
                <input type="number" name="quantity" id="quantity" value="1" min="1" required />
                <input type="hidden" name="product_id" value="1" />
                <input type="hidden" name="product_name" id="product_name" value="Black PS5" />

...
<body data-model="ps4">
    ...
    <section id="details" class="diffitems">
        <div class="mainimage">
            <img src="Consoles/PS4/PS4-black.webp" width="100%" id="product-image" alt="Black PS4" />
            <div class="secimages">
                <div class="secimagescols"><img src="Consoles/PS4/PS4-black.webp" width="100%" class="smallimg" id="black" /></div>
                <div class="secimagescols"><img src="Consoles/PS4/PS4 white.webp" width="100%" class="smallimg" id="white" /></div>
                <div class="secimagescols"><img src="Consoles/PS4/PS4 red.webp" width="100%" class="smallimg" id="red" /></div>
            </div>
        </div>
        <div class="maindescription">
            <h4 id="pname">Black PS4</h4>
            <h2 id="pprice"><del>£599.99</del> £99.99</h2>
            <form action="ps4.php" method="POST">
                <select id="colourselector" name="colour" onchange="updateProductDetails()">
                    <option value="Black" data-price="99.99" data-name="Black PS4" data-image="Consoles/PS4/PS4-black.webp">Black</option>
                    <option value="White" data-price="109.99" data-name="White PS4" data-image="Consoles/PS4/PS4 white.webp">White</option>
                    <option value="Red" data-price="109.99" data-name="Red PS4" data-image="Consoles/PS4/PS4 red.webp">Red</option>
                </select>
                <input type="number" name="quantity" id="quantity" value="1" min="1" required />
                <input type="hidden" name="product_id" value="2" />
                <input type="hidden" name="product_name" id="product_name" value="Black PS4" />

 ...
 <nav class="navbar navbar-expand-lg" id="navbar">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
        <div class="mainimage">
            <img src="Monitors/25inch/2k-25-Black.webp" width ="100%" id="normal" alt ="">
            <div class="secimages">
                <div class="secimagescols">
                    <img src="Monitors/25inch/2k-25-Black.webp" width="100%" class="smallimg" id="black">
                </div>
                <div class="secimagescols">
                    <img src="Monitors/25inch/2k-25-White.webp" width="100%" class="smallimg" id="white">
                </div>
        ...
        <div class="maindescription">
            <br>
           <h4 id="pname">25 Inch Black Monitor 2K</h4>
           <br>
           <h2 id="pprice"><del>£149.99</del> £99.99 </h2>
           <br>
           ...
           <br>
           <br>
           <h4 id="pdescriptionheading" >Product Description: 25 Inch Black Monitor 2K</h4>
           <br>
           <span id="pdescription">Elevate your visual experience with this sleek 25-inch 2K monitor. Boasting a stunning 2560 x 1440 resolution, it delivers sharp, vibrant images for immersive gaming, productivity, or multimedia enjoyment. The monitor's minimalist black design blends seamlessly into any setup, while its ergonomic stand ensures adjustable comfort for long hours of use. Equipped with fast refresh rates and multiple connectivity options, it's perfect for tech enthusiasts and professionals alike.</span>
        </div>

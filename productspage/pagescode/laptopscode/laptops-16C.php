  ...
  <body data-model="c16">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="Laptops/16inch/Chromebook-16-Black.webp"
          width="100%"
          id="normal"
          alt=""
        />
        <div class="secimages">
          ...
          <div class="secimagescols">
            <img
              src="Laptops/16inch/Chromebook-16-white.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">16 inch Black Chromebook</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: 16 inch Black Chromebook
        </h4>
        <br />
        <span id="pdescription"
          >The 16-Inch Chromebook in black combines affordability with a
          spacious display for an enhanced user experience. Ideal for students,
          professionals, and casual users, this laptop runs Chrome OS for fast,
          seamless browsing and app usage. The large 16-inch display offers
          sharp visuals, while the lightweight build makes it portable and
          convenient. Encased in a sleek black finish, this Chromebook is as
          stylish as it is functional.</span
        >
      </div>
    </section>

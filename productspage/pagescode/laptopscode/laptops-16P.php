  ...
  <body data-model="p16">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="Laptops/16inch/Probook-16-black.webp"
          width="100%"
          id="normal"
          alt=""
        />
        <div class="secimages">
          ...
          <div class="secimagescols">
            <img
              src="Laptops/16inch/Probook-16-white.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">16 inch Black Probook</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: 16 inch Black Probook
        </h4>
        <br />
        <span id="pdescription"
          >The 16-Inch Probook in black is built for professionals who need
          powerful performance in a sleek package. Featuring a large,
          high-resolution display, this laptop is perfect for intensive tasks
          like video editing, 3D modeling, or software development. Its robust
          hardware and ergonomic design ensure smooth multitasking and long-term
          comfort. The black finish adds a sophisticated, professional look to a
          laptop that means business.</span
        >
      </div>
    </section>

  ...
  <body data-model="a12">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="Laptops/12inch/Airbook-12-Black.webp"
          width="100%"
          id="normal"
          alt=""
        />
        <div class="secimages">
          ...
          <div class="secimagescols">
            <img
              src="Laptops/12inch/Airbook-12-White.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">12 inch Black Airbook</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: 12 inch Black Airbook
        </h4>
        <br />
        <span id="pdescription"
          >The 12-Inch Airbook in sleek black is the ultimate companion for
          portability and performance. Its compact size makes it perfect for
          on-the-go professionals, while its robust build and elegant black
          finish exude sophistication. Featuring a stunning Retina display,
          lightning-fast SSD storage, and an advanced processor, it handles
          multitasking effortlessly. Whether you're editing documents, streaming
          content, or managing your projects, the 12-Inch Airbook is designed to
          deliver seamless performance in a lightweight package.</span
        >
      </div>
    </section>

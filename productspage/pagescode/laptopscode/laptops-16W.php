  ...
  <body data-model="w16">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="Laptops/16inch/Windows-16-Black.webp"
          width="100%"
          id="normal"
          alt=""
        />
        <div class="secimages">
          ...
          <div class="secimagescols">
            <img
              src="Laptops/16inch/Windows-16-White.webp"
              width="100%"
              class="smallimg"
              id="white"
            />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">16 inch Black Windows</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: 16 inch Black Windows
        </h4>
        <br />
        <span id="pdescription"
          >Power and portability meet style in the 16-Inch Windows Laptop in
          black. With a spacious high-resolution display and the latest Windows
          OS, it’s designed for seamless multitasking and entertainment. Whether
          you’re working on a presentation, streaming content, or gaming, this
          laptop offers sharp visuals and smooth performance. Its sleek black
          design and lightweight build make it a versatile choice for
          professionals and students alike.</span
        >
      </div>
    </section>

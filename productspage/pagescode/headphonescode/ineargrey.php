  ...
  <body>
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img src="Headphones/ineargrey.webp" width="100%" id="normal" alt="" />
        <div class="secimages">
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">In Ear Grey Headphones</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: In Ear Grey Headphones
        </h4>
        <br />
        <span id="pdescription"
          >Discover unmatched comfort and sound clarity with these modern in-ear
          headphones in grey. Designed with precision audio drivers, they
          deliver balanced, high-quality sound for music, calls, or videos. The
          ergonomic design ensures a snug fit, while the understated grey finish
          adds a touch of sophistication. Compact and durable, these headphones
          are perfect for on-the-go users who demand style and performance in
          equal measure.</span
        >
      </div>
    </section>

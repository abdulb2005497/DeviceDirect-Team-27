  ...
  <nav class="navbar navbar-expand-lg" id="navbar">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="Headphones/overearblack.webp"
          width="100%"
          id="normal"
          alt=""
        />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">Over Ear Black Headphones</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: Over Ear Black Headphones
        </h4>
        <br />
        <span id="pdescription"
          >Immerse yourself in powerful, studio-quality sound with these
          over-ear headphones in black. Designed for comfort and performance,
          they feature cushioned ear cups and an adjustable headband for a
          perfect fit. The advanced drivers deliver deep bass, clear mids, and
          vibrant highs, making them ideal for music enthusiasts, gamers, or
          professionals. With noise-canceling technology and a sleek black
          design, these headphones ensure an uninterrupted listening experience,
          even in noisy environments.</span
        >
      </div>
    </section>

  ...
  <body>
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img src="Headphones/inearwhite.webp" width="100%" id="normal" alt="" />
        <div class="secimages">
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">In Ear White Headphones</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: In Ear White Headphones
        </h4>
        <br />
        <span id="pdescription"
          >Upgrade your listening experience with these stylish in-ear
          headphones in white. Featuring crystal-clear sound quality and a
          sleek, minimalist design, they’re perfect for work, travel, or
          workouts. The soft silicone ear tips provide a secure and comfortable
          fit, while noise-isolation technology blocks out distractions.
          Lightweight and portable, these white in-ear headphones combine
          elegance with exceptional performance for the ultimate listening
          experience.</span
        >
      </div>
    </section>

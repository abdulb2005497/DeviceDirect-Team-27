  ...
  <body>
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img src="Headphones/inearblack.webp" width="100%" id="normal" alt="" />
        <div class="secimages">
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">In Ear Black Headphones</h4>
        <br />
        <h2 id="pprice"><del>£20.99</del> £19.99</h2>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: In Ear Black Headphones
        </h4>
        <br />
        <span id="pdescription"
          >Experience premium sound quality with these sleek in-ear headphones
          in black. Engineered for superior audio performance, they deliver
          crisp highs, deep bass, and immersive clarity, making them perfect for
          music, calls, or podcasts. The ergonomic design ensures a secure,
          comfortable fit for all-day wear, while the compact size makes them
          easy to carry wherever you go. With noise-isolation technology and
          durable construction, these black in-ear headphones are a must-have
          for audiophiles on the move.</span
        >
      </div>
    </section>

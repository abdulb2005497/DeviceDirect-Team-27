  ...
  <nav class="navbar navbar-expand-lg" id="navbar">
   ...
    <!-- navbar -->
    ...
    <section id="details" class="diffitems">
      <div class="mainimage">
        <img
          src="Headphones/overearwhite.webp"
          width="100%"
          id="normal"
          alt=""
        />
      ...
      <div class="maindescription">
        <br />
        <h4 id="pname">Over Ear White Headphones</h4>
        <br />
        ...
        <h4 id="pdescriptionheading">
          Product Description: Over Ear White Headphones
        </h4>
        <br />
        <span id="pdescription"
          >Experience elegance and exceptional audio with these over-ear
          headphones in white. Combining comfort and style, they feature plush
          ear cushions and a lightweight frame for long listening sessions. The
          precision-tuned drivers provide dynamic sound with rich bass and
          crystal-clear highs, perfect for music, movies, or calls. Whether
          you’re at home or on the go, these noise-canceling white over-ear
          headphones deliver premium sound and timeless style.</span
        >
      </div>
    </section>
